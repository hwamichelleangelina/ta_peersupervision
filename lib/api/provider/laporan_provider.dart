...
class LaporanProvider with ChangeNotifier {
  final String serverUrl = 'http://34.34.222.113:8080/laporan';
...
Future<List<JadwalList>> fetchJadwalReport() async {
    ...
    final response = await http.get(Uri.parse('http://34.34.222.113:8080/laporan/getJadwal/$psnim'));
  ...
  Future<bool> fetchCheckLaporan(int jadwalid) async {
    final response = await http.get(Uri.parse('http://34.34.222.113:8080/laporan/isLaporanFilled/$jadwalid/'));
