...
class DampinganProvider with ChangeNotifier {
  final String serverUrl = 'http://34.128.89.90:8080/dampingan';
  ...
  Future<bool> checkPertemuan(int reqid) async {
    final response = await http.get(Uri.parse('http://34.128.89.90:8080/dampingan/countPendampingan/$reqid/'));
  ...
  Future<void> updateDampingan(int reqid, Map<String, dynamic> newData) async {
    final url = 'http://34.128.89.90:8080/dampingan/updateDampingan/$reqid';
    try {
