...
class DampinganProvider with ChangeNotifier {
  final String serverUrl = 'https://34.128.89.90:8080/dampingan';
  ...
  Future<bool> checkPertemuan(int reqid) async {
    final response = await http.get(Uri.parse('https://34.128.89.90:8080/dampingan/countPendampingan/$reqid/'));
  ...
  Future<void> updateDampingan(int reqid, Map<String, dynamic> newData) async {
    final url = 'https://34.128.89.90:8080/dampingan/updateDampingan/$reqid';
    try {
